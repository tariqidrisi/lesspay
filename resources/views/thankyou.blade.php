	...
	<div class="container mb-4">
		<div class="jumbotron text-xs-center" style="margin: 100px 0">
		  ...
		  <p class="lead">
			...
			In case of not getting a confirmation email please check your spam folder or contact us at <strong><span class="glyphicon glyphicon-envelope"></span> support@largeskill.com.</strong> Our customer care executive will get in touch with you. <br/>
